...
In addition to my teaching duties, I am also the **Erasmus Project Coordinator**
at the **Institut Tecnològic de Barcelona**.🌍
This role allows me to facilitate international collaboration and provide students
...
### Featured Projects
- **WebApp Mastery**: A comprehensive guide and toolkit for building sophisticated web applications
using PHP and JavaScript.
- **Android Essentials**: Sample projects and tutorials on creating user-friendly Android apps.
- **NetAdmin Toolkit**: Scripts and tools for managing and securing network services like DNS,
 DHCP, Apache, SSH, and FTP.
